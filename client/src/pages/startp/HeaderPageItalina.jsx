    ...
    return(
        <StartContainer>
                <div className='StartPagetextContainer'>
                    <h1>La migliore pizza tradizionale...</h1>
...
const StartContainer=styled.div`
    background-image: linear-gradient(rgba(79, 82, 94, 0),rgba(94, 79, 84, 0.396)),url('https://images.unsplash.com/photo-1579751626657-72bc17010498?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80');
